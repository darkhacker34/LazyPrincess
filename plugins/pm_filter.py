...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/MovieA2Bot?start=Z2V0LTMxNjEyNTM5NzAyNDk5OTE'),
        ] 
    )
...
async def languages_cb_handler(client: Client, query: CallbackQuery):
    ...
    btn.insert(
        ...
        [
            InlineKeyboardButton(
                text="👇 𝖲𝖾𝗅𝖾𝖼𝗍 𝖸𝗈𝗎 want 𝖫𝖺𝗇𝗀𝗎𝖺𝗀𝖾𝗌 👇", callback_data="ident"
            )
        ],
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love @MV_Rockers ♥️')
            else:
                await query.message.edit_text(
                    "I'm not connected to any groups!\nCheck /connections or connect to any groups",
                    quote=True
                )
                return await query.answer('♥️ Thank You MV_Rockers ♥️')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('❤️‍🔥Join All', url='https://t.me/addlist/lDx-uWhVnDxlMGRl')
        ], [
            ...
            InlineKeyboardButton('📞 Owner⪧', url='@PreDVD_ChatBot')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        await query.answer('♥️ Thank You MV_Rockers ♥️')
        ...
        await query.answer("❤️‍🔥Thank You MV_Rockers")
        ...
        try:
            btn = [[
                ...
                InlineKeyboardButton(text=f"⚡️ Join All 🦋", url=f"https://t.me/addlist/lDx-uWhVnDxlMGRl")
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ to ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/MovieA2Bot?start=Z2V0LTMxNjEyNTM5NzAyNDk5OTE'),
        ] 
    )
